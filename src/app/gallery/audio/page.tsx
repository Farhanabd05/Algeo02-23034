...
export default function AudioSearchingPage() {
  ...
  useEffect(() => {
    async function fetchMappedFiles() {
      ...
      try {
        ...
        // console.log("Mapped Files Data:", data); // Tambahkan ini
  ...
  const handleAudioSearch = async () => {
    ...
    try {
      ...
      console.log("Result dari API:", result); // Tambahkan ini
      
      if (response.ok) {
        console.log("Similar Audios:", result.similaraudios); // Dan ini
        const similarFiles = result.similaraudios
          .map((similarAudio: SimilarAudio) => {
            ...
            console.log("Similar Audio:", similarAudio); // Tambahkan debugging
            console.log("Mapped File:", mappedFile); // Tambahkan debugging    
          ...
          .filter(Boolean);
        console.log("Similar Files setelah mapping:", similarFiles);
